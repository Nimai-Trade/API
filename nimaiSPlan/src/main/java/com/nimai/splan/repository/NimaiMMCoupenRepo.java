...
public interface NimaiMMCoupenRepo extends JpaRepository<NimaiMMCoupen, String>
{
  ...
  //  NimaiMMCoupen getCouponDetailsByDiscId(Integer discountId);
    ...
    @Query(value = "SELECT coupon_type from nimai_m_discount where COUPON_CODE=(:coupenCode) and status='Active' and CONSUMED_COUPONS<quantity and subscription_plan=(:subscriptionName) and coupon_for=(:couponFor) and country=(:businesscountry)", nativeQuery = true)
